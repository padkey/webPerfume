            ...
            <div class="row">
                ...
                <div class="col-md-8 col-lg-9 p-b-80">
                    <div class="p-r-45 p-r-0-lg">
                        <!-- item blog -->
                        @foreach($allPostByCate as $key => $post)
                        <div class="p-b-63">
                            <a href="{{url('/postDetail/'.$post->post_slug)}}" class="hov-img0 how-pos5-parent">
                                <img src="{{URL::to('public/uploads/posts/'.$post->post_image)}}" alt="IMG-BLOG"  >
                            ...
                            <div class="p-t-32">
                                <h4 class="p-b-15">
                                    <a href="{{url('/postDetail/'.$post->post_slug)}}" class="ltext-108 cl2 hov-cl1 trans-04">
                                        {{$post->post_title}}
                                    </a>
                                </h4>
                        ...
                        {!! $allPostByCate->links('vendor.pagination.bootstrap-4')!!}
                        </div>
                    </div>
                </div>
